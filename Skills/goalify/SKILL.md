...
- When preparing a goal for Codex CLI, keep the generated goal under 4,000 characters.
- If the source context is too large for that limit, summarize aggressively and point to files instead.
